...
class Category(ButtonControl):
    def __init__(self, x: int, y: int, width: int, height: int, category_name: str, display_text: str="", color: tuple[int, int, int]=(255, 255, 255), colorB: tuple[int, int, int]=(0, 0, 0), colorT: tuple[int, int, int]=(0, 0, 0), font_size: int=30, offset_x: int=10, offset_y: int=10, border_size: int=3, img: py.surface.Surface | None=None):
